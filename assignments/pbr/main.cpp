...
void render(ew::Shader shader, ew::Model model, GLuint texture) {
	...
	shader.setFloat("_Material.metallic", material.metallic);
	shader.setFloat("_Material.roughness", material.roughness);
...
int main() {
	...
	ew::Shader litShader = ew::Shader("assets/pbr.vert", "assets/pbr.frag");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// Main Render
		render(litShader, monkeyModel, brickTexture);
